exports.handler = async function(event, context) {
    ...
    try {
        ...
        // Grabs your newly saved key from Netlify!
        ...
        Comment on their health or wealth dynamically. Do not offer to heal them (the game UI handles that).`;
        ...
        return {
            statusCode: 500,
            body: JSON.stringify({ reply: "The Innkeeper stares at you blankly. (Server Error)" }),
        };
    }
};